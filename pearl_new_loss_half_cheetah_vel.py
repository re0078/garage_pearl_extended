...
from garage.torch.algos.pearl import PEARLWorker, PEARL
from pearl_extended import PEARLExtended
from garage.torch.embeddings import MLPEncoder
from garage.torch.policies import ContextConditionedPolicy
from garage.torch.policies import TanhGaussianMLPPolicy
from garage.torch.q_functions import ContinuousMLPQFunction
from state_functions.state_function import \
    ContinuousMLPStateFunction
...
@wrap_experiment
def pearl_new_loss_half_cheetah_vel(ctxt=None,
                                    seed=1,
                                    num_epochs=500,
                                    num_train_tasks=100,
                                    num_test_tasks=30,
    ...
    state_model_env = PEARL.get_env_spec(env[0](), latent_size, 'statem')
    state_model = ContinuousMLPStateFunction(env_spec=state_model_env,
...
pearl_new_loss_half_cheetah_vel()
